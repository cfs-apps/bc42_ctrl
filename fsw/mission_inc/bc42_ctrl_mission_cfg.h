...
**
**  Purpose:
**    Define mission scope configurations for the BC42 Controller app
**
**  Notes:
...
**       compile time. Use bc42_ctrl_platform_cfg.h for compile-time
...
#ifndef _bc42_ctrl_mission_cfg_
#define _bc42_ctrl_mission_cfg_


#endif /* _bc42_ctrl_mission_cfg_ */
